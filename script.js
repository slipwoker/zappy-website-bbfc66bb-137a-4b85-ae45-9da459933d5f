        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'bbfc66bb-137a-4b85-ae45-9da459933d5f',
                name: data.name || '',
                email: data.email || '',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Sigal Arkanso uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
